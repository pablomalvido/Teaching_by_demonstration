...
#ROS init
rospy.init_node('compare_sequence_classify')
...
if object_name == "taping_gun":
	#seq_name = "10_grasp_hammer_place-B1.1_B1.1_B1.1" #12,10,13,15,19,30
	#seq_name = "49_grasp_pourwater_place-B1.1_B2.1_B1.1"
	seq_name="16_grasp_tape_place-B1.1_B1.1_B1.1" #13(1,1,1),16(1,1,1),30(1,3,3)
